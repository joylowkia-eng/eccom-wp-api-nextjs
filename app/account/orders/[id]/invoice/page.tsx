...
export default function InvoicePage() {
    ...
    const order = {
        ...
        subtotal: 155.97,
        tax: 12.48, // Added mock tax for realism
        shipping: 0,
        total: 168.45,
        customer: {
            name: 'Jane Doe',
    ...
    return (
        <main className="min-h-screen bg-white text-[#2C2C2C] p-8 md:p-16 print:md-0 print:p-0">
            <div className="max-w-4xl mx-auto border border-gray-200 p-8 print:p-0 shadow-sm print:shadow-none print:border-0">
                {/* Header */}
